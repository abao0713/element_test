...
attribute = driver.find_element_by_css_selector("input[type='submit']").get_attribute('type')
#返回元素的css属性值
css_attribute = driver.find_element_by_link_text("新闻").value_of_css_property("font-size")
